...
if(WIN32)
  set(PNG_url "https://sourceforge.net/projects/libpng/files/libpng${PNG_major_minor_no_dot}/${PNG_version}/lpng${PNG_major_minor_no_dot}${PNG_version_patch}.zip")
  set(PNG_md5 "9fe57702faf291504b83786e6516528a")
else()
  set(PNG_url "https://sourceforge.net/projects/libpng/files/libpng${PNG_major_minor_no_dot}/${PNG_version}/libpng-${PNG_version}.tar.gz")
  set(PNG_md5 "03fbc5134830240104e96d3cda648e71")
endif()
