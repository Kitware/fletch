...
if(fletch_ENABLE_CPython)
  ...
  set_property(CACHE Qt_SELECT_VERSION PROPERTY STRINGS "3.6.8" "3.8.13" "3.10.4")
  set(fletch_PYTHON_MAJOR_VERSION "3" CACHE INTERNAL "Required for CPython" FORCE)

  set(CPython_version ${CPython_SELECT_VERSION})
  string(REPLACE "." ";" CPython_VERSION_LIST ${CPython_version})
  ...
  if(CPython_version_minor EQUAL "10")
    set(CPython_md5 "716d1a13c474c237a4044f129d9d7168")
  elseif(CPython_version_minor EQUAL "8")
    set(CPython_md5 "3daa024d29598baf42ee33019d4b5746")
  elseif(CPython_version_minor EQUAL "6")
    set(CPython_version_modifier m)
    set(CPython_md5 "8a6fc9ef517c383b8d9a1aa5aebb7376")
  else()
