...
if(fletch_ENABLE_CPython)
  ...
  set_property(CACHE CPython_SELECT_VERSION PROPERTY STRINGS "3.6.15" "3.8.13" "3.10.4 3.13.3")
  ...
  elseif(CPython_SELECT_VERSION VERSION_EQUAL 3.13.3)
    set(CPython_version_modifier t)
    set(CPython_md5 "8cb2914dd48755bff44a49f930930d0e")
  else()
...
set(PROJ_url "https://data.kitware.com/api/v1/file/6622b26cdf5a87675edbc0dc/download/proj.${PROJ_version}.tar.gz" )
