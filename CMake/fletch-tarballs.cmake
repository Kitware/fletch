...
if (fletch_ENABLE_Protobuf OR fletch_ENABLE_ALL_PACKAGES OR AUTO_ENABLE_CAFFE_DEPENDENCY)
  set(Protobuf_SELECT_VERSION "3.6.0.1" CACHE STRING "Select the  version of ProtoBuf to build.")
  if(MSVC)
    set_property(CACHE Protobuf_SELECT_VERSION PROPERTY STRINGS "2.7.0" "3.4.1" "3.6.0.1")
  else()
  set_property(CACHE Protobuf_SELECT_VERSION PROPERTY STRINGS "2.5.0" "2.6.1" "2.7.0" "3.4.1" "3.6.0.1")
  endif()
endif()

set(Protobuf_version ${Protobuf_SELECT_VERSION})
set(Protobuf_url "https://github.com/google/protobuf/archive/v${Protobuf_SELECT_VERSION}.zip" )

if (Protobuf_version VERSION_EQUAL 2.5.0)
  if(MSVC)
    message( FATAL_ERROR "Only Protobuf 2.7.0 and later is not supported in MSVC" )
  endif()
  set(Protobuf_md5 "a72001a9067a4c2c4e0e836d0f92ece4" )
elseif (Protobuf_version VERSION_EQUAL 2.6.1)
  if(MSVC)
    message( FATAL_ERROR "Only Protobuf 2.7.0 and later is not supported in MSVC" )
  endif()
  set(Protobuf_md5 "d914c9d720b8fdc818367b7b2395e90e" )
elseif (Protobuf_version VERSION_EQUAL 2.7.0)
  # 2.7 is a quasi release made to bridge the divide between proto2 and proto3
  # It is also the first and only version of proto2 that supports CMake
  # Which makes it the only proto2 version readily available for use by MS Visual Studio
  set(Protobuf_md5 "a4c5d3f0db9c79b0de846e3e2f834d6a" )
  set(Protobuf_url "https://github.com/google/protobuf/archive/${Protobuf_SELECT_VERSION}.zip" )
elseif (Protobuf_version VERSION_EQUAL 3.4.1)
  set(Protobuf_md5 "74446d310ce79cf20bab3ffd0e8f8f8f" )
elseif (Protobuf_version VERSION_EQUAL 3.6.0.1)
...
set(Protobuf_use_cmake ON)
if (${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION} VERSION_LESS 3.7)
  set(Protobuf_use_cmake OFF)
  if(WIN32)
    message( STATUS "Using CMake ${CMAKE_MAJOR_VERSION}.${CMAKE_MINOR_VERSION}")
    message( FATAL_ERROR "Protobuf on windows requires CMake 3.7 or greater" )
  endif()
endif()
