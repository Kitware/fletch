...
if(fletch_ENABLE_CPython)
  set(CPython_SELECT_VERSION 3.8 CACHE STRING "Select the version of Python to build.")
  set_property(CACHE CPython_SELECT_VERSION PROPERTY STRINGS "3.6" "3.8" "3.10")
  ...
  if(CPython_SELECT_VERSION VERSION_EQUAL "3.6")
    set(CPython_version_minor 6)
    set(CPython_version_patch 15)
    set(CPython_version_modifier m)
    set(CPython_md5 "325c4c92c8f0efadf1aba8d70b1f74e3")
  elseif(CPython_SELECT_VERSION VERSION_EQUAL "3.8")
    set(CPython_version_minor 8)
    set(CPython_version_patch 13)
    set(CPython_md5 "3daa024d29598baf42ee33019d4b5746")
  elseif(CPython_SELECT_VERSION VERSION_EQUAL "3.10")
    set(CPython_version_minor 10)
    set(CPython_version_patch 4)
