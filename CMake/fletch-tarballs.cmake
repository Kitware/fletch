...
set(PNG_version_patch 37)
set(PNG_version "${PNG_version_major}.${PNG_version_minor}.${PNG_version_patch}")
set(PNG_url "https://sourceforge.net/projects/libpng/files/libpng16/${PNG_version}/libpng-${PNG_version}.tar.gz")
set(PNG_md5 "6c7519f6c75939efa0ed3053197abd54")
...
if(fletch_ENABLE_qtExtensions OR fletch_ENABLE_ALL_PACKAGES)
  if(qtExtensions_SELECT_VERSION STREQUAL "latest")
    ...
    set(qtExtensions_version "20210129git38e70b32")
    set(qtExtensions_tag "38e70b32807c0317cc3804a6dad303f1b0ec2e13")
    set(qtExtensions_md5 "ef9e3d0b4115864934260046567b11a6")
  else()
