...
if(WIN32)
  ...
  if(APPLE)
    set(env_var DYLD_LIBRARY_PATH=${fletch_BUILD_INSTALL_PREFIX}/lib)
    if(NOT "$ENV{DYLD_LIBRARY_PATH}" STREQUAL "")
      set(env_var "${env_var}:$ENV{DYLD_LIBRARY_PATH}")
    endif()
  else()
    set(env_var LD_LIBRARY_PATH=${fletch_BUILD_INSTALL_PREFIX}/lib)
    if(NOT "$ENV{LD_LIBRARY_PATH}" STREQUAL "")
      set(env_var "${env_var}:$ENV{LD_LIBRARY_PATH}")
    endif()
  endif()
  set(Qt_build ${env} ${env_var} ${MAKE_EXECUTABLE})
