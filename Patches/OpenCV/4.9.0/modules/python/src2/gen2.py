...
# Add the script's directory to sys.path so hdr_parser can be found
# This is needed when the build system runs the script from a different directory
import os
import sys
...
class FuncInfo(object):
    ...
    def gen_code(self, codegen):
        # NOTE: This is a large function that generates C++ wrapper code.
        # The full implementation continues from the original file.
        # For brevity, we include a placeholder that calls the rest of the logic.
        all_classes = codegen.classes
