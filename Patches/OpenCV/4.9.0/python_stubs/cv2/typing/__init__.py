...
# Avoid circular imports - only import cv2 modules during type checking
...
if _typing.TYPE_CHECKING:
    ...
    FeatureDetector = _typing.Any
    DescriptorExtractor = _typing.Any
    FeatureExtractor = _typing.Any
    GProtoArg = _typing.Any
    GProtoInputArgs = _typing.Sequence[_typing.Any]
    GProtoOutputArgs = _typing.Sequence[_typing.Any]
    GRunArg = _typing.Any
    GOptRunArg = _typing.Optional[_typing.Any]
    GMetaArg = _typing.Any
    Prim = _typing.Any
    GTypeInfo = _typing.Any
    ExtractArgsCallback = _typing.Callable[..., _typing.Any]
    ExtractMetaCallback = _typing.Callable[..., _typing.Any]
    LayerId = _typing.Any
