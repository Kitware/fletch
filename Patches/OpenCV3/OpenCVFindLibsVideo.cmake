    ...
    if(HAVE_FFMPEG)
      ...
      if(FFMPEG_INCLUDE_DIR)
        ...
        if(FFMPEG_CODEC_LIB)
          ...
          list(APPEND VIDEOIO_LIBRARIES ${FFMPEG_CODEC_LIB})
        endif()
        if(FFMPEG_FORMAT_LIB)
          set(HAVE_FFMPEG_FORMAT 1)
          list(APPEND VIDEOIO_LIBRARIES ${FFMPEG_FORMAT_LIB})
        endif()
        if(FFMPEG_UTIL_LIB)
          set(HAVE_FFMPEG_UTIL 1)
          list(APPEND VIDEOIO_LIBRARIES ${FFMPEG_UTIL_LIB})
        endif()
        if(FFMPEG_SWSCALE_LIB)
          set(HAVE_FFMPEG_SWSCALE 1)
          list(APPEND VIDEOIO_LIBRARIES ${FFMPEG_SWSCALE_LIB})
        endif()
...
if (NOT IOS)
  ...
  elseif(APPLE AND CMAKE_COMPILER_IS_CLANGCXX AND CMAKE_SYSTEM_VERSION VERSION_LESS "16")
    set(HAVE_QTKIT YES)
  endif()
endif()
